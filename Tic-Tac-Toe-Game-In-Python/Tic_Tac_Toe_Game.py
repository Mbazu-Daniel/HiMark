...
def ButtonClick(id):
    ...
    #checking for winner   
    if( build1['text']=='X' and build2['text']=='X' and build3['text']=='X' or
        build4['text']=='X' and build5['text']=='X' and build6['text']=='X' or
        build7['text']=='X' and build8['text']=='X' and build9['text']=='X' or
        build1['text']=='X' and build4['text']=='X' and build7['text']=='X' or
        build2['text']=='X' and build5['text']=='X' and build8['text']=='X' or
        build3['text']=='X' and build6['text']=='X' and build9['text']=='X' or
        build1['text']=='X' and build5['text']=='X' and build9['text']=='X' or
        build3['text']=='X' and build5['text']=='X' and build7['text']=='X'):
            disableButton()
            c=1
            tkinter.messagebox.showinfo("Tic Tac Toe","Winner is player 1")
    elif( build1['text']=='O' and build2['text']=='O' and build3['text']=='O' or
        build4['text']=='O' and build5['text']=='O' and build6['text']=='O' or
        build7['text']=='O' and build8['text']=='O' and build9['text']=='O' or
        build1['text']=='O' and build4['text']=='O' and build7['text']=='O' or
        build2['text']=='O' and build5['text']=='O' and build8['text']=='O' or
        build3['text']=='O' and build6['text']=='O' and build9['text']=='O' or
        build1['text']=='O' and build5['text']=='O' and build9['text']=='O' or
        build3['text']=='O' and build5['text']=='O' and build7['text']=='O'):
            disableButton()
            c=1
